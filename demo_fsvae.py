...
def test_sample(network, testloader):
    ...
    with torch.no_grad():
        ...
        torchvision.utils.save_image((real_img+1) / 2, f'demo_imgs/demo_input_fsvae.png')
        torchvision.utils.save_image((x_recon+1) / 2, f'demo_imgs/demo_recons_fsvae.png')
...
def sample(network):
    ...
    with torch.no_grad():
        ...
        torchvision.utils.save_image((sampled_x+1) / 2, f'demo_imgs/demo_sample_fsvae.png')
...
if __name__ == '__main__':
    ...
    print('save demo_imgs/demo_input_fsvae.png')
    print('save demo_imgs/demo_recons_fsvae.png')
    print('save demo_imgs/demo_sample_fsvae.png')
    print("###############################")
